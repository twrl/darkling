 ...
 *
 * The service bus communicates between the `ServiceClient` (caller thread),
 ...
 * abstracts the underlying message channel so that the bus can operate over
 * real Web Workers, `MessagePort`s, or an in-process mock for testing.
 *
